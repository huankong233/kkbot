 ...
 * @param {String} mine
 */
export function getExt(mine) {
  const index = Array.from(contentTypes.values()).indexOf(mine)
  return Array.from(contentTypes.keys())[index]
}
