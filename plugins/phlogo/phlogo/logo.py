...
def create_right_part_img(text: str, font_size: int):
    ...
    draw = ImageDraw.Draw(image)
    draw.text((left_blank, blank_height),
              text,
    ...
    circle = Image.new("L", (magnified_radii * 2, magnified_radii * 2),
                       0)  # 创建一个黑色背景的画布
    ...
    alpha = Image.new("L", (magnified_alpha_width, magnified_alpha_height),
                      255)
    alpha.paste(circle.crop((0, 0, magnified_radii, magnified_radii)),
                (0, 0))  # 左上角
    alpha.paste(
        circle.crop(
            (magnified_radii, 0, magnified_radii * 2, magnified_radii)),
        (magnified_alpha_width - magnified_radii, 0),
    )  # 右上角
    alpha.paste(
        circle.crop((magnified_radii, magnified_radii, magnified_radii * 2,
                     magnified_radii * 2)),
        (
    ...
    alpha.paste(
        circle.crop(
            (0, magnified_radii, magnified_radii, magnified_radii * 2)),
